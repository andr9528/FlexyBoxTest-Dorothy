...
namespace Dorothy.Proxy.Controllers
{
    ...
    public class SearchControllerProxy : ControllerProxy, ISearchController<ResultProxy, SearchProxy>
    {
        ...
        private async Task<ResultProxy> SearchFiles(SearchProxy search)
        {
            ...
            var result = new ResultProxy() { SearchId = search.Id, Results = results, ResultType = Core.Enums.ResultType.Files, ToltalResults = allFiles.Length };
            return result;
        }
        ...
        private async Task<ResultProxy> SearchFolders(SearchProxy search)
        {
            ...
            var result = new ResultProxy() { SearchId = search.Id, Results = results, ResultType = Core.Enums.ResultType.Folder, ToltalResults = allfolders.Length };
            return result;
        }
    }
}
